...
BUILTIN_DEFAULTS: dict[str, str] = {
    ...
    "videogen.wan22-t2v": "wan22-t2v",
    "videogen.wan22-i2v": "wan22-i2v",
    "videogen.wan22-flf2v": "wan22-i2v",
    ...
    "videogen.seedvr2-upscale": "seedvr2",
...
BUILTIN_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "krea2-turbo": {
        ...
        "models": {
            "unet": "diffusion_models/krea2_turbo_fp8_scaled.safetensors",
    ...
    "wan22-i2v": {
        ...
        "architecture": "wan22",
        "supports": ["videogen.wan22-i2v", "videogen.wan22-flf2v"],
        "models": {
            "unet_high": "diffusion_models/wan2.2_i2v_high_noise_14B_fp8_scaled.safetensors",
            "unet_low": "diffusion_models/wan2.2_i2v_low_noise_14B_fp8_scaled.safetensors",
    ...
    "wan22-t2v": {
        ...
        "architecture": "wan22",
        "supports": ["videogen.wan22-t2v"],
        "models": {
            "unet_high": "diffusion_models/wan2.2_t2v_high_noise_14B_fp8_scaled.safetensors",
            "unet_low": "diffusion_models/wan2.2_t2v_low_noise_14B_fp8_scaled.safetensors",
            "text_encoder": "text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors",
            "vae": "vae/wan_2.1_vae.safetensors",
        },
        "defaults": {
    ...
    "wan22-dasiwa-tastysin-i2v": {
        "label": "Dasiwa WAN 2.2 I2V 14B TastySin",
        "architecture": "wan22",
        "supports": ["videogen.wan22-i2v", "videogen.wan22-flf2v"],
        "models": {
            "unet_high": "diffusion_models/DasiwaWAN22I2V14BV8V1_tastysinHighV81.safetensors",
            "unet_low": "diffusion_models/DasiwaWAN22I2V14BV8V1_tastysinLowV81.safetensors",
            "text_encoder": "text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors",
            "vae": "vae/wan_2.1_vae.safetensors",
        },
        "defaults": {
    ...
    "wan22-dasiwa-tastysin-t2v": {
        "label": "Dasiwa WAN 2.2 T2V 14B TastySin",
        "architecture": "wan22",
        "supports": ["videogen.wan22-t2v"],
        "models": {
            "unet_high": "diffusion_models/DasiwaWAN22I2V14BV8V1_tastysinHighV81.safetensors",
    ...
    "wan22-dasiwa-boundbite-i2v": {
        "label": "Dasiwa WAN 2.2 I2V 14B BoundBite",
        "architecture": "wan22",
        "supports": ["videogen.wan22-i2v", "videogen.wan22-flf2v"],
        "models": {
            "unet_high": "diffusion_models/DasiwaWAN22I2V14BLightspeed_boundbiteHighV10.safetensors",
            "unet_low": "diffusion_models/DasiwaWAN22I2V14BLightspeed_boundbiteLowV10.safetensors",
            "text_encoder": "text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors",
            "vae": "vae/wan_2.1_vae.safetensors",
        },
        "defaults": {
    ...
    "wan22-dasiwa-boundbite-t2v": {
        "label": "Dasiwa WAN 2.2 T2V 14B BoundBite",
        "architecture": "wan22",
        "supports": ["videogen.wan22-t2v"],
        "models": {
            "unet_high": "diffusion_models/DasiwaWAN22I2V14BLightspeed_boundbiteHighV10.safetensors",
    ...
    "wan22-s2v": {
        "label": "WAN 2.2 S2V 14B FP8",
        "architecture": "wan22",
        "supports": ["videogen.wan22-s2v"],
        "models": {
            "unet": "diffusion_models/wan2.2_s2v_14B_fp8_scaled.safetensors",
            "text_encoder": "text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors",
    ...
    "wan22-dasiwa-littledemon-v2-s2v": {
        "label": "Dasiwa WAN 2.2 S2V 14B LittleDemon v2",
        "architecture": "wan22",
        "supports": ["videogen.wan22-s2v"],
        "models": {
            "unet": "diffusion_models/DasiwaWan2214BS2V_littledemonV2.safetensors",
            "text_encoder": "text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors",
            "audio_encoder": "audio_encoders/wav2vec2_large_english_fp16.safetensors",
            "vae": "vae/wan_2.1_vae.safetensors",
        },
    ...
    "wan22-dasiwa-littledemon-v2-video-audio": {
        "label": "Dasiwa WAN 2.2 S2V 14B LittleDemon v2 Video+Audio",
        "architecture": "wan22",
        "supports": ["videogen.wan22-video-audio"],
        "models": {
            "unet": "diffusion_models/DasiwaWan2214BS2V_littledemonV2.safetensors",
            "text_encoder": "text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors",
            "audio_encoder": "audio_encoders/wav2vec2_large_english_fp16.safetensors",
        ...
        "defaults": {
            ...
            "denoise": 0.35,
            "lipsync_steps": 4,
            "lipsync_denoise": 0.45,
            "lipsync_second_steps": 2,
            "lipsync_second_denoise": 0.25,
            "cfg": 1.0,
            "sampler": "euler",
            "scheduler": "simple",
            "shift": 10.0,
            "audio_driven_prompt": "Audio-reactive motion, expressive movement, coherent video.",
            "lipsync_prompt": "Speaking. Talking. Expressive lip movement.",
            "negative_prompt": "",
        },
    },
    "wan22-bernini": {
        "label": "WAN 2.2 Bernini Video Edit",
        "architecture": "wan22",
        "supports": ["videogen.wan22-bernini"],
        "models": {
            "unet_high": "diffusion_models/Wan22_Bernini_HIGH_fp8_e4m3fn_scaled.safetensors",
            "unet_low": "diffusion_models/Wan22_Bernini_LOW_fp8_e4m3fn_scaled.safetensors",
            "lora": "loras/wan22/lightx2v_T2V_14B_cfg_step_distill_v2_lora_rank64_bf16.safetensors",
        ...
        "defaults": {
            ...
            "split_step": 4,
            "cfg": 1.0,
            "high_lora_strength": 3.0,
            "low_lora_strength": 1.5,
    ...
    "minimax-h3": {
        ...
        "defaults": {
            ...
            "length": 124,
            "steps": 4,
            "turbo_lora": "loras/minimax/minimax_h3_turbo_4step_ckpt850.safetensors",
            "seed": 0,
    ...
    "seedvr2": {
        "label": "SeedVR2 Video Upscaler",
        "architecture": "seedvr2",
        "supports": ["videogen.seedvr2-upscale"],
        "models": {},
        "defaults": {
            "resolution": "1080p",
